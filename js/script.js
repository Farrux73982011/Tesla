...
let kals = document.querySelectorAll('.kals')
let kals2 = document.querySelectorAll('.kals2')
let sped_kals = 0
...
up.onclick = () =>{
    ...
    energy.innerHTML = `${energy_value} km`
    speed.innerHTML = `${speed_value} km/h`
    kals.style.animation = `coles ${sped_kals}s linear -2s infinite`
    kals2.style.animation = `coles ${sped_kals}s linear -2s infinite`
...
up3.onclick = () =>{
    ...
    price.innerHTML = price_value
    disks.innerHTML = disks_value
    kals.style.width = '100px'
    kals2.style.height = '100px'
}
...
down3.onclick = () =>{
    ...
    price.innerHTML = price_value
    disks.innerHTML = disks_value
    kals.style.width = '95px'
    kals.style.height = '95px'
}
...
c_3.style.display = 'block'
        ...
        // kals.style.display = 'none'
        // kals2.style.display = 'none'
